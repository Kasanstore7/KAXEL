...
global.authFile = `${opts._[0] || 'kasan'}.data.json`
...
async function connectionUpdate(update) {
  ...
  if (update.receivedPendingNotifications) conn.sendMessage(`120363029019153128@g.us`, {text: 'Bot Online!\n\nVersion: 2, 2208, 14 WhatsApp Business, isLatest: true\n\nKode: DCD48D02A90ED6A0A00DC706B3A2C574' })
}
